...
#card-btn:hover, #card-submit:hover {
                ...
                <!-- <div class="card"> -->
                    ...
                    <!-- <div id="collapseOne" class="collapse" aria-labelledby="headingOne"> -->
                        <!-- <div class="card-body"> -->
                            ...
                            <div class="col-md-12 animate__animated animate__fadeInUp">
                                ...
                                Payment details will be completed here.
                                </p>
                                <form method="POST" action="bill-card">
                                {{ csrf_field()}}
                                ...
                                <div id="card-front">
                                    ...
                                    <input type="text" name="card-number" id="card-number" placeholder="1234 5678 9101 1112" length="16">
                                    <div id="cardholder-container" class="pt-2">
                                    <label for="card-holder">Card Holder
                                    </label>
                                    <input type="text" name="card-holder" id="card-holder" placeholder="e.g. John Doe" />
                                    </div>
                                    <!--- end card holder container --->
                                    <div id="exp-container">
                                    <label for="card-exp" class="pt-2">
                                        Expiration
                                        </label>
                                    <input id="card-month" name="card-month" type="text" placeholder="MM" length="2">
                                    <input id="card-year" name="card-year" type="text" placeholder="YY" length="2">
                                    </div>
                                        <div id="cvc-container">
                                    <label for="card-cvc" style="margin-left: 6"> CVC/CVV</label>
                                    <input id="card-cvc" name="card-cvc" placeholder="XXX-X" type="text" min-length="3" max-length="4">
                                ...
                                <!-- <div class="pt-2">
                                <button type="submit"  id="card-submit" style="margin-top: 10px; "class="form-group btn btn-dark">{{ __('Submit') }}</button>
                                </div> -->

                                <!-- <button type="submit" class="pt-5" id="card-btn">Submit</button> -->
                                

                                <!-- <div id="card-btn" class="form-group row mb-0 pt-3">
                    ...
                    <div> -->
                                ...
                                <div class= "form-group row">
                                    <!-- <div class="row"> -->
                                        <div class="col-md-6">
                                        <button type="button" id="card-btn" class="form-control">Check your card</button>
                                        </div>
                                        <div class="col-md-6">
                                        <button type="submit"  id="card-submit" class="form-control">{{ __('Submit') }}</button>
                                        </div>
                                    <!-- </div> -->
</div>
                                ...
                                <!-- <form method="POST" action="sender">
                                    @csrf -->
                                        ...
                                        <div class="form-group row">
                                            <label for="weigth" class="col-md-4 col-form-label text-md-right">{{ __('Weigth (kg)') }}</label>
