                ...
                <!-- <div class="card animate__animated animate__fadeInUp">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne">
                        <div class="card-body">
                                        ...
                                        We proceed your information. Go below to complete the receiver profile. -->
                                 ...
                                 <form method="POST" action="receiver">
                                    ...
                                    <div>
                                        ...
                                        <div id="locationField">
                                            <input id="destination-input" name="destination-input" autocomplete="off"
                                        ...
                                        <table id="address">
                                            ...
                                            <tr>
                                                ...
                                                <td class="wideField"><input class="field" id="postal_code" name="postal_code" disabled="true" autocomplete="off" required/></td>
                                            </tr>
                                            <tr>
...
function initAutocomplete() {
  ...
  document.getElementById('destination-input'), {types: ['geocode']});
