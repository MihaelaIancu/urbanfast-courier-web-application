...
<div class="container">
  ...
  <div class="col-md-8">
    <div class="profile-bar">
      <div class="contents">
        <img src="https://cdn3.iconfinder.com/data/icons/medical-2-1/512/test-512.png" alt="UserAvatar">
      <p class="profile-name pb-3">Order History</p>

      <table class="pl-2 pt-4 table text-center text-white" style="font-size: 14px !important;">
                                <thead>
                                    <tr>
                                        <th class="border-0 text-uppercase small font-weight-bold">Package No</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Status</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Placed Order On</th>
                                    </tr>
                                </thead>
